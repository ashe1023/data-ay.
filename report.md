    ...
    <OL TYPE=A>
      <li>歷史由來
        <OL>
          ...
          <LI><H5>投資計畫：投資商品可獲得高額回報</H5>
          <LI><H5>結果：騙局泡沫破裂，龐茲破產</H5>
        </OL>
      <li>例子
          <OL>
            <LI><H5>老鼠會</H5>
      ...
      <li>核心
          <H5>挖東牆補西牆，利用後投資者進駐的資金，來當前投資者的收益，且有承諾在固定時間必會獲得其收益，使投資者相信這是一筆穩賺的投資</H5>
      <li>維持方式 
          <OL>
            <LI><H5>無極限的單向性增長：幾何級數的增長</H5>
            <LI><H5>良好預期：偏離現實</H5>
            <LI><H5>信念：無物質基礎</H5>
            <LI><H5>調整標的物：樹立新信念</H5>
          </OL>
    </OL>
